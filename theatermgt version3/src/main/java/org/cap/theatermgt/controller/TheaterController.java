...
public class TheaterController {
	...
	@PostMapping("/add")
	public ResponseEntity<Theater> addTheater(@RequestBody CreateTheaterRequest theaterDto) {
	...
	private Theater convert(CreateTheaterRequest theaterdto) {
