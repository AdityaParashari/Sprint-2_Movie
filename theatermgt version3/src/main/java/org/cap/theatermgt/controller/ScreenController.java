...
public class ScreenController {
	...
	@PostMapping("/add/{id}")
	public ResponseEntity<TheaterDetailsDto> addScreen(@RequestBody CreateScreenRequest screenDto, @PathVariable("id") int theaterId){
	...
	private Screen convertScreen(CreateScreenRequest screenDto)
	{
